#!/bin/bash
# =====================================================================================================
# Copyright (C) steady.sh v2.0 2016 iicc (@yagop)
# =====================================================================================================
...
VOLUNTARYCHECK=0
I=1
BOT=devpoint  # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
echo -e "               \e[01;34m                    by yagop                 \e[00;37;40m"
echo ""
cat << EOF
...
echo ""
echo -e "\033[38;5;208m @BombusMOD    :)      @Ntflight \033[0;00m"
echo -e "\033[38;5;208m @BombusMOD    :)      @Ntflight \033[0;00m"
echo -e "\033[38;5;208m @BombusMOD    :)      @Ntflight \033[0;00m"
echo -e "\033[38;5;208m @BombusMOD    :)      @Ntflight \033[0;00m"
echo -e "\033[38;5;208m @BombusMOD    :)      @Ntflight \033[0;00m"
...
while getopts ":tsTSih" opt; do
  case $opt in
	...
	echo -e "\e[1m"
	echo -e ""
	echo "steady.sh bash script c2.0 yagop 2016 BombusMOD" >&2
	echo ""
	echo -e "\e[0m"
